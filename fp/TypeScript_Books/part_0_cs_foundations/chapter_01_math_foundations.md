...
> Hãy BỎ QUA toàn bộ Part 0 và nhảy thẳng đến **[Chapter 4: The TypeScript Ecosystem & Tooling](../part_1_fundamentals/chapter_04_getting_started.md)** để cài đặt TypeScript và code thực hành ngay lập tức. Đừng ép bản thân đọc lý thuyết Toán học khi chưa quen với code, vì nó rất dễ gây nản lòng! Bạn hoàn toàn có thể quay lại đây đọc sau khi đã thành thạo cú pháp cơ bản.
