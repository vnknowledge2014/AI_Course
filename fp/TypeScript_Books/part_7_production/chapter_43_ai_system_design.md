...
- **Gateway (TypeScript)**: Xử lý rate limiting, API Key validation, load balancing.

```typescript
// TypeScript làm API Gateway cho LLM
async function llmGateway(req: Request): Promise<Response> {
