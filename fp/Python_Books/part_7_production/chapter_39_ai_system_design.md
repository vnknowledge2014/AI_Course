...
>
> **Yêu cầu trước**: Chapter 38 (System Design)
...
- **Gateway (Python)**: Xử lý rate limiting, API Key validation, load balancing.

```python
// Python làm API Gateway cho LLM
async def llm_gateway(req: Request) -> Response:
